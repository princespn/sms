            ...
            <div class="col-md-12">
                <div class="section-title">
                    ...
                    <div class="text-center mb-9 mt-9" id="contact-row">
                        ...
                        <div class="title">
                            <h6><span><?php echo e(__('About')); ?></span> <?php echo e(__('Us')); ?></h6>
                            <p><?php echo e(__('Who we are?')); ?></p>
                        </div>
        ...
        <div class="container pt-9">         
            ...
            <div class="row d-flex" id="about-us">
                ...
                <div class="col-md-6" id="about-title">
                    ...
                    <div class="title">
                        <h6><?php echo e(__('Synthesize Text with')); ?> <span><?php echo e(config('app.name')); ?></span></h6>
                        <p class="p-about"><?php echo e(__('We make to text to speech conversion easier and fun')); ?></p>
                    </div>

                    <img class="w-70" src="<?php echo e(URL::asset('img/files/home-1.jpg')); ?>" alt="">
                ...
                <div class="col-md-6" id="about-info">
                    ...
                    <a href="<?php echo e(route('contact.show')); ?>" class="btn btn-primary special-action-button"><?php echo e(__('Contact Us')); ?></a>
            ...
            <div class="row d-flex text-center">
                ...
                <div class="col-md-12 mb-4">
                    <h6><?php echo e(__('Voiceover production is easires and faster with us')); ?></h6>
                    <p class="mb-3 p-about"><?php echo e(__('Enjoy full flexibility of text to speech synthesize tasks')); ?></p>
                </div>
                    ...
                    <div class="card-body p-5">                        
                        <div class="col-md-12">
                            <ul class="nav nav-pills w-100 mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><?php echo e(__('Standard & Neural Voices')); ?></a>
                                </li>                       
                            
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false"><?php echo e(__('Multiple Voice Effects')); ?></a>
                                </li>                        
                            
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false"><?php echo e(__('Various Payment Options')); ?></a>
                                </li>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12 text-left pt-9 pr-7">
                                            <h4><?php echo e(__('Standard & Neural Voices')); ?></h4>
                                            <p>Choose from a set of 746+ voices across 129+ languages and dialects, including Mandarin, Hindi, Spanish, Arabic, Russian, and more. Pick the voice that works best for your user and application.</p>
                                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary">Sign Up Now</a>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <img class="w-70" src="<?php echo e(URL::asset('img/svgs/banner-1.svg')); ?>" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12 text-left pt-9 pr-7">
                                            <h4><?php echo e(__('Multiple Voice Effects')); ?></h4>
                                ...
                                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12 text-left pt-9 pr-7">
                                            <h4><?php echo e(__('Various Payment Options')); ?></h4>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/about.blade.php ENDPATH**/ ?>