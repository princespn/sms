	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('Invoice Settings')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
					...
					<form action="<?php echo e(route('admin.settings.invoice.store')); ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="row">		
							<div class="col-md-6 col-sm-12">							
								<div class="input-box">	
									<h6><?php echo e(__('Invoice Currency')); ?></h6>
							...
							<div class="col-md-6 col-sm-12">							
								<div class="input-box">	
									<h6><?php echo e(__('Invoice Language')); ?></h6>
							...
							<div class="col-md-6 col-sm-12">
								<div class="input-box">								
									<h6><?php echo e(__('Company Name')); ?></h6>
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-md-4 col-sm-12">							
								<div class="input-box">	
									...
									<select id="invoice-country" name="invoice_country" data-placeholder="Select Invoice Country:">	
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/settings/invoice/index.blade.php ENDPATH**/ ?>