    ...
    <div class="row justify-content-md-center">
        <div class="col-md-6 col-sm-12">   
            <div class="install-path text-center mt-9 mb-5">
                <span class="btn mr-2 active"><i class="mdi mdi-apps"></i></span>
                ...
                <span class="btn mr-2"><i class="mdi mdi-account-check"></i></span>	
            </div>
            <div class="card overflow-hidden border-0 special-shadow mt-5 mb-5">	
                ...
                <div class="card-body mt-7">                                                  
                    ...
                    <div id="install-wrapper" class="text-center pb-7">
                        <span><i class="mdi mdi-apps"></i></span>
                        <p><?php echo e(config('app.name')); ?> Installation Wizard</p>
                    </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/install/index.blade.php ENDPATH**/ ?>