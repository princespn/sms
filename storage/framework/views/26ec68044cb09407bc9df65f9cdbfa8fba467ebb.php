	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				<li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-th-large mr-2 fs-12"></i><?php echo e(__('Admin')); ?></a></li>
...
<?php $__env->startSection('content'); ?>						
	...
	<div class="row">
				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['new_users_current_month'][0]['data'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="users_change"></span> <?php echo e(__('this month')); ?></span></h2>
					...
					<div class="d-flex mt-2">
						<div>
							...
							<span class="number-font fs-12"><i class="fa fa-chain mr-1 text-success"></i><?php echo e(number_format($total_data_monthly['new_users_past_month'][0]['data'])); ?></span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?> (<?php echo e(__('Total')); ?>)</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-success"></i><?php echo e(number_format($total_data_yearly['total_new_users'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['new_subscribers_current_month'][0]['data'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="subscribers_change"></span> <?php echo e(__('this month')); ?></span></h2>
						</div>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Last Month')); ?></span>
							<span class="number-font fs-12"><i class="fa fa-chain mr-1 text-success"></i><?php echo e(number_format($total_data_monthly['new_subscribers_past_month'][0]['data'])); ?></span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?> (<?php echo e(__('Total')); ?>)</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-success"></i><?php echo e(number_format($total_data_yearly['total_new_subscribers'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0"><span class="number-font fs-20">$<?php echo e(number_format((float)$total_data_monthly['spending_current_month'], 2, '.', '')); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="spending_change"></span> <?php echo e(__('this month')); ?></span></h2>
						</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12"><?php echo e(__('Free Characters Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
					<h2 class="mb-2 number-font fs-20"><?php echo e(number_format($total_data_monthly['free_chars'][0]['data'])); ?></h2>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12"><?php echo e(__('Paid Characters Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
					<h2 class="mb-2 number-font fs-20"><?php echo e(number_format($total_data_monthly['paid_chars'][0]['data'])); ?></h2>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12"><?php echo e(__('Purchased Characters')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
					<h2 class="mb-2 number-font fs-20"><?php echo e(number_format($total_data_monthly['purchased_chars'][0]['data'])); ?></h2>
					<small class="fs-12 text-muted"><?php echo e(__('Compared to Last Month')); ?> (<span id="purchased_chars_past"></span>): </small>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12"><?php echo e(__('Synthesized Audio Results')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
					<h2 class="mb-2 number-font fs-20"><?php echo e(number_format($total_data_monthly['audio_files'][0]['data'])); ?></h2>
					<small class="fs-12 text-muted"><?php echo e(__('Compared to Last Month')); ?> (<span id="audio_files_past"></span>): </small>
	...
	<div class="row mt-4">
				...
				<div class="card-body">
					<div class="row mb-5 mt-2">	
						<div class="col-xl-3 col-12 ">
							...
							<h3 class="mb-0 fs-20 number-font"><?php echo config('payment.default_system_currency_symbol'); ?><?php echo e(number_format($total_data_yearly['total_income'][0]['data'])); ?></h3>
						</div>
						<div class="col-xl-3 col-12 ">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Spending')); ?></p>
							<h3 class="mb-0 fs-20 number-font">$<?php echo e(number_format((float)$total_data_yearly['total_spending'], 2, '.', '')); ?></h3>
						</div>
						<div class="col-xl-3 col-12 ">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Chars Purchased')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($total_data_yearly['total_purchased_chars'][0]['data'])); ?></h3>
						</div>
						<div class="col-xl-3 col-12 ">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Purchased Chars Used')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($total_data_yearly['total_purchased_chars_used'][0]['data'])); ?></h3>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
		...
		<div class="col-lg-6 col-md-12">
			<div class="card overflow-hidden border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('New Users Analysis')); ?> <span class="text-muted">(<?php echo e(__('Current Year')); ?>)</span></h3>
				</div>
				<div class="card-body">
					<div class="row mb-5 mt-2">
						<div class="col-xl-3 col-6">
							<p class="mb-1 fs-12"><?php echo e(__('Total New Users')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($total_data_yearly['total_new_users'][0]['data'])); ?></h3>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>