							...
							<div class="col-sm-12 col-md-12">
								<div class="form-group">
									...
									<select id="user-status" name="status" data-placeholder="Select User Status">	
										...
										<option value="deactivated" <?php echo e(($user->status == 'deactivated') ? 'selected' : ''); ?>>Deactivated</option>																		
									</select>
							...
							<div class="col-sm-12 col-md-12">
								<div class="form-group">
									...
									<select id="user-group" name="group" data-placeholder="Select User Group">	
										<option value="user" <?php echo e(($user->group == 'user') ? 'selected' : ''); ?>>User</option>
										<option value="subscriber" <?php echo e(($user->group == 'subscriber') ? 'selected' : ''); ?>>Subscriber</option>
										<option value="admin" <?php echo e(($user->group == 'admin') ? 'selected' : ''); ?>>Administrator</option>																		
									</select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/user-management/list/edit.blade.php ENDPATH**/ ?>