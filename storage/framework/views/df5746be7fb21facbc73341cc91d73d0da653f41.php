		...
		<div class="col-xl-5 col-lg-5 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('License Activation')); ?>: <?php if($notification): ?> <span class="text-success">Activated</span> <?php else: ?> <span class="text-danger">Not Activated</span><?php endif; ?></h3>
				</div>
				<div class="card-body">
...
unset($__errorArgs, $__bag); ?>" name="license" value="<?php echo e(config('settings.envato.activation')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php echo e(config('settings.envato.username')); ?>" required>
...
unset($__errorArgs, $__bag); ?>									
								...
								<?php if($notification): ?> <span class="text-success fs-12">Congratulations! Application Successfully Activated!</span> <?php else: ?> <span class="text-danger fs-12">Application is Not Activated.</span><?php endif; ?>
							</div>
						</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/settings/activation/index.blade.php ENDPATH**/ ?>