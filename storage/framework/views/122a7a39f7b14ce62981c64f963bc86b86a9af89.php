...
<?php $__env->startSection('content'); ?>						
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				<div class="card-body">
					...
					<p class=" mb-3 fs-12 font-weight-bold mt-1"><?php echo e(__('Total Subscribed Users')); ?></p>
					<h2 class="mb-0"><span class="number-font-chars"><?php echo e(number_format($user_data_year['total_paid_users'][0]['data'])); ?></span></h2>					
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				<div class="card-body">
					...
					<h2 class="mb-0"><span class="number-font-chars"><?php echo e($users); ?></span></h2>
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
	...
	<div class="row mt-4">
		...
		<div class="col-lg-12 col-md-12">
			<div class="card overflow-hidden border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('New Registered Users ')); ?><span class="text-muted">(<?php echo e(__('Current Year')); ?>)</span></h3>
				</div>
				<div class="card-body">
					<div class="row mb-5 mt-2">
						<div class="col-xl-3 col-6">
							<p class="mb-1 fs-12"><?php echo e(__('Total Free Tier Users')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($user_data_year['total_free_tier'][0]['data'])); ?></h3>
						</div>
						<div class="col-xl-3 col-6 ">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Paid Tier Users')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($user_data_year['total_paid_tier'][0]['data'])); ?></h3>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/user-management/dashboard/index.blade.php ENDPATH**/ ?>