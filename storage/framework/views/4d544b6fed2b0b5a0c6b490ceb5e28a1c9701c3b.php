				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0"><span class="number-font fs-20">$<?php echo e(number_format((float)$total_data_monthly['spending_current_month'], 2, '.', '')); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span class="fs-12" id="spending_difference"></span> <?php echo e(__('this month')); ?></span></h2>
						</div>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Last Month')); ?>:</span>
							<span class="number-font fs-12"><i class="fa fa-chain mr-1 text-danger"></i>$<?php echo e(number_format((float)$total_data_monthly['spending_past_month'], 2, '.', '')); ?></span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?>:</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-danger"></i>$<?php echo e(number_format((float)$total_data_yearly['total_spending'], 2, '.', '')); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Total Chars Purchased')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['purchased_chars'][0]['data'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span class="fs-12" id="purchased_chars_difference"></span> <?php echo e(__('this month')); ?></span></h2>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Last Month')); ?>:</span>
							<span class="number-font fs-12"><i class="fa fa-chain mr-1 text-success"></i><?php echo e(number_format($total_data_monthly['purchased_chars_past'][0]['data'])); ?></span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?>:</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-success"></i><?php echo e(number_format($total_data_yearly['total_purchased_chars'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Total Purchased Chars Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['paid_chars'][0]['data'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span class="fs-12" id="purchased_chars_used_difference"></span> <?php echo e(__('this month')); ?></span></h2>
						</div>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Last Month')); ?>:</span>
							<span class="number-font fs-12"><i class="fa fa-chain mr-1 text-success"></i><?php echo e(number_format($total_data_monthly['paid_chars_past'][0]['data'])); ?></span>
						</div>
						<div class="ml-auto">
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?>:</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-success"></i><?php echo e(number_format($total_data_yearly['total_purchased_chars_used'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Estimated AWS Spending')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font-chars">$<?php echo e(number_format((float)$total_data_monthly['aws_current_month'], 2, '.', '')); ?></span></h2>									
						</div>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?>: </span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-danger"></i>$<?php echo e(number_format((float)$total_data_yearly['aws_current_year'], 2, '.', '')); ?></span>
						</div>
					</div>
					<div class="d-flex">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Standard Characters Used')); ?> (<?php echo e(__('Current Year')); ?>): </span>
							<span class="number-font fs-12"><?php echo e(number_format($total_data_yearly['aws_current_year_std'][0]['data'])); ?></span>
						</div>
					</div>
					<div class="d-flex">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Neural Characters Used')); ?> (<?php echo e(__('Current Year')); ?>): </span>
							<span class="number-font fs-12"><?php echo e(number_format($total_data_yearly['aws_current_year_nrl'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Estimated GCP Spending')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font-chars">$<?php echo e(number_format((float)$total_data_monthly['gcp_current_month'], 2, '.', '')); ?></span></h2>
						</div>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?>:</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-danger"></i>$<?php echo e(number_format((float)$total_data_yearly['gcp_current_year'], 2, '.', '')); ?></span>
						</div>
					</div>
					<div class="d-flex">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Standard Characters Used')); ?> (<?php echo e(__('Current Year')); ?>): </span>
							<span class="number-font fs-12"><?php echo e(number_format($total_data_yearly['gcp_current_year_std'][0]['data'])); ?></span>
						</div>
					</div>
					<div class="d-flex">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Neural Characters Used')); ?> (<?php echo e(__('Current Year')); ?>): </span>
							<span class="number-font fs-12"><?php echo e(number_format($total_data_yearly['gcp_current_year_nrl'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Estimated Azure Spending')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font-chars">$<?php echo e(number_format((float)$total_data_monthly['azure_current_month'], 2, '.', '')); ?></span></h2>
						</div>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?>: </span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-danger"></i>$<?php echo e(number_format((float)$total_data_yearly['azure_current_year'], 2, '.', '')); ?></span>
						</div>
					</div>
					<div class="d-flex">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Standard Characters Used')); ?> (<?php echo e(__('Current Year')); ?>): </span>
							<span class="number-font fs-12"><?php echo e(number_format($total_data_yearly['azure_current_year_std'][0]['data'])); ?></span>
						</div>
					</div>
					<div class="d-flex">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Neural Characters Used')); ?> (<?php echo e(__('Current Year')); ?>): </span>
							<span class="number-font fs-12"><?php echo e(number_format($total_data_yearly['azure_current_year_nrl'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Estimated IBM Spending ')); ?><span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font-chars">$<?php echo e(number_format((float)$total_data_monthly['ibm_current_month'], 2, '.', '')); ?></span></h2>
						</div>
					...
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?>: </span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-danger"></i>$<?php echo e(number_format((float)$total_data_yearly['ibm_current_year'], 2, '.', '')); ?></span>
						</div>
					</div>					
					<div class="d-flex">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Neural Characters Used')); ?> (<?php echo e(__('Current Year')); ?>): </span>
							<span class="number-font fs-12"><?php echo e(number_format($total_data_yearly['ibm_current_year_nrl'][0]['data'])); ?></span>
						</div>
					</div>
					<div class="d-flex">
						<div>
			...
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body">
					<div class="row mb-5 mt-2">	
						...
						<div class="col-xl-3 col-12 ">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Estimated Spending')); ?></p>
							<h3 class="mb-0 fs-20 number-font">$<?php echo e(number_format((float)$total_data_yearly['total_spending'], 2, '.', '')); ?></h3>
						</div>
					</div>
					<div class="row">
		...
		$(function() {
			...
			new Chart(ctx, {
				...
				data: {
					...
					datasets: [{
						label: 'Total Income (<?php echo e(config('payment.default_system_currency')); ?>) ',
						data: incomeDataset,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/finance-management/dashboard/index.blade.php ENDPATH**/ ?>