...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0"><?php echo e(__('All Subscriptions')); ?></h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> <?php echo e(__('All Subscriptions')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('All User Subscriptions')); ?></h3>
				</div>
					...
					<table id='mySubscriptionsTable' class='table' width='100%'>
							<thead>
								<tr>
									...
									<th width="7%"><?php echo e(__('Bonus')); ?></th>
									<th width="10%"><?php echo e(__('Next Payment On')); ?></th>
		...
		<div class="modal-dialog modal-dialog-centered modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel"><i class="mdi mdi-alert-circle-outline color-red"></i> <?php echo e(__('Confirm Subscription Cancellation')); ?></h4>
	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#mySubscriptionsTable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "<?php echo e(route('admin.finance.payments.subscriptions')); ?>",
				columns: [{
						data: 'created-on',
						name: 'created-on',
						orderable: true,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/finance-management/payments/subscriptions.blade.php ENDPATH**/ ?>