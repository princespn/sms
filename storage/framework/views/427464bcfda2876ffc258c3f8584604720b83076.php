...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0"><?php echo e(__('Synthesize Result Detail')); ?></h4>
			<ol class="breadcrumb mb-2">
				<li class="breadcrumb-item"><a href="<?php echo e(route('user.tts')); ?>"><i class="mdi mdi-audiobook mr-2 fs-12"></i><?php echo e(__('User')); ?></a></li>
				<li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('user.tts.results')); ?>"> <?php echo e(__('My TTS Audio Results')); ?></a></li>
				<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('Synthesize Result Detail')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
				...
				<div class="card-body pt-5">		
					...
					<div class="row pt-7">
						<div class="col-12 mb-5">
							<h6 class="font-weight-bold mb-1"><?php echo e(__('Project Name')); ?>: </h6>
					...
					<div class="border-0 text-right mb-2 mt-8">
						<a href="<?php echo e(route('user.tts.results')); ?>" class="btn btn-primary"><?php echo e(__('Return')); ?></a>
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/user/tts-results/show.blade.php ENDPATH**/ ?>