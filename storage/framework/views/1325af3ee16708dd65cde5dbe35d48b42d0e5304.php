                    ...
                    <div class="col-md-5 col-sm-12 h-100" id="login-responsive">                
                        <div class="card-body pr-10 pl-10 pt-10">
                            <form method="POST" action="<?php echo e(route('register')); ?>">
                                ...
                                <h3 class="text-center font-weight-bold mb-8">Sign Up to <span class="text-info"><a href="<?php echo e(url('/')); ?>"><?php echo e(config('app.name')); ?></a></span></h3>
                                ...
                                <div class="form-group">  
                                    <div class="d-flex">                        
                                        <label class="custom-switch">
                                            ...
                                            <span class="custom-switch-description fs-10 text-muted">By continuing, I agree with your <a href="<?php echo e(route('terms')); ?>" class="text-info">Terms and Conditions</a> and <a href="<?php echo e(route('privacy')); ?>" class="text-info">Privacy Policies</a></span>
                                        </label>   
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="row align-items-center">
                                    <div class="col-md-12 col-sm-12 fs-10 text-muted text-center">
                                        Copyright © <?php echo e(date("Y")); ?> <a href="<?php echo e(config('app.url')); ?>"><?php echo e(config('app.name')); ?></a>. All rights reserved
                                    </div>
                                </div>
                            </div>
                        </footer>       
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>