	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('Registration')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
								...
								<div class="input-box">	
									<h6><?php echo e(__('New User Registration')); ?></h6>
			  						<select id="registration" name="registration" data-placeholder="Select Registration Option:">			
										<option value="enabled" <?php if( config('settings.registration')  == 'enabled'): ?> selected <?php endif; ?>>Enabled</option>
										<option value="disabled" <?php if( config('settings.registration')  == 'disabled'): ?> selected <?php endif; ?>>Disabled</option>
									</select>
								</div> 						
							</div>
								...
								<div class="input-box">	
									<h6><?php echo e(__('New User Email Verification')); ?></h6>
			  						<select id="email-verification" name="email-verification" data-placeholder="Select Email Verification Option:">			
										<option value="enabled" <?php if( config('settings.email_verification')  == 'enabled'): ?> selected <?php endif; ?>>Enabled</option>
										<option value="disabled" <?php if( config('settings.email_verification')  == 'disabled'): ?> selected <?php endif; ?>>Disabled</option>
									</select>
								</div> 						
							</div>
							...
							<div class="col-12">							
								<div class="input-box">	
									<h6><?php echo e(__('Default Country')); ?></h6>
			  						<select id="user-country" name="country" data-placeholder="Select Default User Country:">			
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/settings/registration/index.blade.php ENDPATH**/ ?>