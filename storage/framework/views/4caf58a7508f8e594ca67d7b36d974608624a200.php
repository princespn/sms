...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		...
		<div class="page-rightheader">
			<a href="<?php echo e(route('admin.settings.blog.create')); ?>" class="btn btn-primary mt-1">Create New Blog</a>
		</div>
	</div>
	<!-- END PAGE HEADER -->
<?php $__env->stopSection(); ?>
					...
					<table id='blogsTable' class='table' width='100%'>
							<thead>
								<tr>
									...
									<th width="7%"><?php echo e(__('Created By')); ?></th>
		...
		<div class="modal-dialog modal-dialog-centered modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel"><i class="mdi mdi-alert-circle-outline color-red"></i> <?php echo e(__('Confirm Blog Post Deletion')); ?></h4>
...
<?php $__env->startSection('js'); ?>
	...
	<script type="text/javascript">
		$(function () {
			...
			$(document).on('click', '#deleteBlogButton', function(event) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/settings/blog/index.blade.php ENDPATH**/ ?>