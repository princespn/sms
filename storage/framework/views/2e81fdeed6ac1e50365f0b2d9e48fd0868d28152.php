	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('Appearance Settings')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card border-0 special-shadow">
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4">Footer Logo</h6>
									...
									<div class="col-sm-12 col-md-6">
										<div class="input-box">
											...
											<div class="input-group file-browser">									
												...
												<label class="input-group-btn">
													<span class="btn btn-primary special-btn">
														Browse <input type="file" name="footer_logo" style="display: none;">
													</span>
												</label>
											</div>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card border-0 special-shadow">
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4">Secondary Minimized Logo</h6>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/settings/appearance/index.blade.php ENDPATH**/ ?>