    ...
    <div class="row h-100vh align-items-center background-white">
        <div class="col-md-5 col-sm-12 h-100">                
            <div class="card-body pr-10 pl-10 pt-10">
                ...
                <h3 class="text-center font-weight-bold mb-8">Welcome to <span class="text-info"><?php echo e(config('app.name')); ?></span></h3>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/auth/password/forgot-password.blade.php ENDPATH**/ ?>