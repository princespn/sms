	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('SMTP')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
...
unset($__errorArgs, $__bag); ?>
								...
								<div class="input-box">	
									<h6><?php echo e(__('SMTP Encryption')); ?></h6>
			  						<select id="smtp-encryption" name="smtp-encryption" data-placeholder="Select SMTP Encryption Type:">			
										<option value="tls" <?php if( config('mail.mailers.smtp.encryption')  == 'tls'): ?> selected <?php endif; ?>>TLS</option>
										<option value="ssl" <?php if( config('mail.mailers.smtp.encryption')  == 'ssl'): ?> selected <?php endif; ?>>SSL</option>
									</select>
								</div> 							
							</div>
						...
						<div class="border-0 text-right mb-2 mt-1">
							<button href="#" type="button" class="btn btn-cancel mr-2" data-toggle="modal" data-target="#test-email"><?php echo e(__('Test')); ?></button>
		  	...
		  	<div class="modal-content">
				...
				<form class="send-email" action="<?php echo e(route('admin.settings.smtp.test')); ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="modal-footer pr-6 pb-4">
					  <button type="button" class="btn btn-cancel" data-dismiss="modal"><?php echo e(__('Cancel')); ?></button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/settings/smtp/index.blade.php ENDPATH**/ ?>