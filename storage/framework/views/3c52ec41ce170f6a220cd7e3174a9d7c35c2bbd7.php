	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> <?php echo e(__('Mass Notifications')); ?></a></li>
			</ol>
		</div>
	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#allNotificationsTable').DataTable({
				...
				"order": [[ 1, "desc" ]],
				language: {
					"emptyTable": "<div><img id='no-results-img' src='<?php echo e(URL::asset('img/files/no-notification.png')); ?>'><br>You have not created any mass notifications yet</div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/notification/index.blade.php ENDPATH**/ ?>