                                ...
                                <div id="afrikaans" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player">
                                          <?php if(config('tts.vendor_logos') == 'show'): ?> <img src="<?php echo e(URL::asset('img/csp/gcp-ssm.png')); ?>" alt=""> <?php endif; ?>																	
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/iminathi.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                  ...
                                  <div id="arabic" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                    <div class="card-body mb-2">
                                        ...
                                        <div class="voice-player mb-6">
                                            <?php if(config('tts.vendor_logos') == 'show'): ?> <img src="<?php echo e(URL::asset('img/csp/aws-ssm.png')); ?>" alt=""> <?php endif; ?>																	
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/aws/zeina.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/ahmad.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/abdulla.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/saniya.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/amina-nrl.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/ahmad-nrl.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                            <span class="voice-name">Ahmad <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                            <p class="neural-voice">Neural</p>								
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/abdulla-nrl.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                            <span class="voice-name">Abdulla <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                            <p class="neural-voice">Neural</p>								
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/saniya-nrl.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                            <span class="voice-name">Saniya <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                            <p class="neural-voice">Neural</p>								
                                        ...
                                        <!-- VOICE AUDIO FILE -->
                                    <div class="voice-player mb-6">
                                        <?php if(config('tts.vendor_logos') == 'show'): ?> <img src="<?php echo e(URL::asset('img/csp/ibm-ssm.png')); ?>" alt=""> <?php endif; ?>																	
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/omar.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <!-- VOICE AUDIO FILE -->
                                    <div class="voice-player mb-6">
                                        <?php if(config('tts.vendor_logos') == 'show'): ?> <img src="<?php echo e(URL::asset('img/csp/azure-ssm.png')); ?>" alt=""> <?php endif; ?>																	
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hoda.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/naayf.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/salma.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/shakir.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/zariyah.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hamed.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="bengali" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/aarya.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/achintya.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/aarya-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Aarya <span class="text-muted font-weight-normal fs-12">(F)</span></span>	
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/achintya-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Achintya <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                ...
                                <div id="bulgaria" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/maria.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ivan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/kalina.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/borislav.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="catalan" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/martina.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/herena.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/alba.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/joanna.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/enric.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                  ...
                                  <div id="chinese" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionVoiceList">
                                    <div class="card-body mb-2">
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/aws/zhiyu.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/changying.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/boqin.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/delun.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/tyantyan.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/changying-nrl.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                            <span class="voice-name">Changying <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                            <p class="neural-voice">Neural</p>											
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/boqin-nrl.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                            <span class="voice-name">Boqin <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                            <p class="neural-voice">Neural</p>											
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/delun-nrl.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                            <span class="voice-name">Delun <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                            <p class="neural-voice">Neural</p>											
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/tyantyan-nrl.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                            <span class="voice-name">TyanTyan <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                            <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/lina.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/wangwei.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/zhangjing.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/danny.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/tracy.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hiugaai.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hiumaan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/wanlung.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/huihui.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/kangkang.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/yaoyao.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/xiaoxiao.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/xiaoyou.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/xiaomo.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/xiaoxuan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/xiaohan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/xiaorui.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/yunyang.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/yunye.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/yunxi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hanhan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/yating.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/zhiwei.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hsiaochen.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hsiaoyu.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/yunjhe.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="hongkong" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/sonia.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/wing.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/bonnie.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/chi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="croatia" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/matej.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/gabrijela.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/srecko.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="czeck" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/eliska.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <!-- VOICE AUDIO FILE -->
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="<?php echo e(URL::asset('voices/gcp/eliska-nrl.mp3')); ?>" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                            <span class="voice-name">Eliska <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                            <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/jakub.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/vlasta.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/antonin.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="danish" class="collapse" aria-labelledby="headingThree" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/naja.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/mads.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/ida.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/morten.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/freja.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/josefine.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/ida-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Ida <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/morten-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Morten <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/freja-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Freja <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/josefine-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Josefine <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/helle.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/christel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/jeppe.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="dutch" class="collapse" aria-labelledby="headingFour" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/lotte.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/ruben.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/mila.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/arend.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/christiaan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/lotte.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lotte <span class="text-muted font-weight-normal fs-12">(F)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->	
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/fenna.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/mila-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Mila <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/arend-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Arend <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/christiaan-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Christiaan <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/lotte-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lotte <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/fenna-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Fenna <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/emma.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/liam.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/dena.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/arnaud.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hanna.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/colette.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/fenna.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Fenna <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/maarten.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-australia" class="collapse" aria-labelledby="headingFive" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/nicole.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/olivia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/russell.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/charlotte.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/noah.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/amelia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/oliver.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/charlotte-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Charlotte <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/noah-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Noah <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/amelia-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Amelia <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/oliver-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Oliver <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/craig.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/madison.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/catherine.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hayley.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/natasha.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/william.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-canada" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/heather.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/linda.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/clara.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/liam.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Liam <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                ...
                                <div id="hongkong-en" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/yan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/sam.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-in" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/aditi.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/raveena.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/saanvi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sai.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/veer.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/prisha.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/saanvi-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Saanvi <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sai-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Sai <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/veer-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Veer <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/prisha-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Prisha <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/heera.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/priya.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ravi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/neerja.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/prabhat.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="ireland-en" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/sean.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/emily.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/connor.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="newzealand" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/molly.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/mitchell.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="philippines-en" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/rosa.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/james.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="singapore-en" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/luna.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/wayne.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="southafrica-en" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/leah.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/luke.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-uk" class="collapse" aria-labelledby="headingSix" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/amy.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/emma.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Emma <span class="text-muted font-weight-normal fs-12">(F)</span></span>								
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/brian.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/amy-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Amy <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/emma-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Emma <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/brian-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Brian <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/poppy.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/charles.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/elsie.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/harry.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/nancy.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/poppy-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Poppy <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/charles-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Charles <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/elsie-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Elsie <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/harry-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Harry <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/nancy-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Nancy <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/charlotte.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Charlotte <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/james.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">James <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/kate.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/george.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hazel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/susan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/libby.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/mia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ryan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-us" class="collapse" aria-labelledby="headingEight" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/ivy.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/joanna.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Joanna <span class="text-muted font-weight-normal fs-12">(F)</span></span>								
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/kendra.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/kimberly.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/salli.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/joey.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/justin.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/matthew.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/ivy-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Ivy <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/joanna-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Joanna <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/kendra-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Kendra <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/kimberly-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Kimberly <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/Salli-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Salli <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/joey-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Joey <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/justin-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Justin <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/matthew-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Matthew <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/kevin-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/bush.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dick.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/caroline.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/trump.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/suzan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/kimberly.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Kimberly <span class="text-muted font-weight-normal fs-12">(F)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/ellen.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/teresa.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/oscar.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/obama.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dick-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Dick <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/bush-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Bush <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/caroline-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Caroline <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/trump-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Trump <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/susan-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Susan <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/kimberly-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Kimberly <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/ellen-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Ellen <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/teresa-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Teresa <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/oscar-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Oscar <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/obama-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Obama <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/allison.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/emily.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Emily <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/henry.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/kevin.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Kevin <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/lisa.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/michael.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/olivia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Olivia <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/benjamin.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/guy.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/aria.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/zira.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/jenny.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-welsh" class="collapse" aria-labelledby="headingNine" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/geraint.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                ...
                                <div id="estonian" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/anu.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/kert.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="filipino" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/princess.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/andrea.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/angel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/nathaniel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/princess-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Princess <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/angel-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Angel <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/andrea-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Andrea <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/nathaniel-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Nathaniel <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                ...
                                <div id="finnish" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/enni.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/enni-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Enni <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/heidi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/noora.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/selma.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/harri.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="french-bg" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/charline.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/gerard.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="french" class="collapse" aria-labelledby="headingTen" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/celine.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/lea.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/mathieu.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/mathilde.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/foucauld.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/louise.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/florent.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/alice.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/mathilde-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Mathilde <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/foucauld-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Foucauld <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/louise-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Louise <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/florent-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Florent <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/alice-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Alice <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/nicolas.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/renee.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hortense.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/julie.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/paul.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/denise.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/henri.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="french-ca" class="collapse" aria-labelledby="heading11" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/chantal.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/gabrielle-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/emma.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Emma <span class="text-muted font-weight-normal fs-12">(F)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/thomas.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/lea.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lea <span class="text-muted font-weight-normal fs-12">(F)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/william.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">William <span class="text-muted font-weight-normal fs-12">(M)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/emma-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Emma <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/thomas-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Thomas <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/lea-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lea <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/william-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">William <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/caroline.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Caroline <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/harmonie.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/sylvie.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/antonie.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/jean.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="switzerland-fr" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/guillaume.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ariane.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/fabrice.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="german-at" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/michael.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Michael <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ingrid.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/jonas.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="german" class="collapse" aria-labelledby="heading12" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/marlene.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/vicky.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/hans.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/eva.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/wilhelm.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/hannah.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/alfred.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/werner.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/merkel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/eva-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Eva <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/wilhelm-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Wilhelm <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/hannah-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Hannah <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/alfred-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Alfred <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/werner-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Werner <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/merkel-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Merkel <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/birgit.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/dieter.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/erika.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hedda.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/stefan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/katja.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/conrad.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="switzerland-gr" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/karsten.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/leni.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/jan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="greek" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/eleni.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/eleni-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Eleni <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/stefanos.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/athina.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/nestoras.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="gujarati" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/inika.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/jhinuk.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/inika-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Inika <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/jhinuk-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Jhinuk <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/dhwani.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/niranjan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="israel" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/asaf.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hila.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/avri.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="hindi" class="collapse" aria-labelledby="heading13" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/aditi-in.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                          <span class="voice-name">Aditi <span class="text-muted font-weight-normal fs-12">(F)</span></span>									  
                                      </div><!-- END VOICE AUDIO FILE -->
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/arunima.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/ayaan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/keshav.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/bhavna.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/arunima-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Arunima <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/ayaan-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Ayaan <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/keshav-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Keshav <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/bhavna-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Bhavna <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hemant.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/kalpana.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/swara.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/madhur.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="hungarian" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/lena.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/lena-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lena <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/szabolcs.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/noemi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/tamas.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="icelandic" class="collapse" aria-labelledby="heading14" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/dora.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/karl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/helga.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="indonesian" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/aulia.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/arief.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/fadhlan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dewi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/aulia-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Aulia <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/arief-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Arief <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/fadhlan-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Fadhlan <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dewi-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Dewi <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/andika.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/gadis.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ardi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="irish" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/orla.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/colm.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="italian" class="collapse" aria-labelledby="heading15" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/carla.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/bianca.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/giorgio.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/federica.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/bella.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/luca.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/matteo.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/federica-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Federica <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/bella-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Bella <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/luca-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Luca <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/matteo-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Matteo <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/francesca.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/cosimo.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/lucia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/elsa.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/isabella.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/diego.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="japanese" class="collapse" aria-labelledby="heading16" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/mizuki.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/takumi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/manami.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sakura.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sensei.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/takuya.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/manami-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Manami <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sakura-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Sakura <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sensei-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Sensei <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/takuya-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Takuya <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/emi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ayumi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/haruka.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ichiro.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/nanami.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/keita.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="kannada" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/aarushi.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/arjun.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/aarushi-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Aarushi <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/arjun-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Arjun <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                ...
                                <div id="korean" class="collapse" aria-labelledby="heading17" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/seoyeon.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/seoyeon-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Seoyeon <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/yong.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/eun-kyong.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/beom-soo.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/byung-joon.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/yong-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Yong <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/eun-kyung-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/beom-soo-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Beom-Soo <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/byung-joon-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Byung-Joon <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/hyunjun.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/siwoo.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/youngmi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/yuna.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/heami.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/sunhi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/injoon.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="latvian" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/andris.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/everita.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/nils.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="lithuania" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ona.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/leonas.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="malay" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/rizwan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/yasmin.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/osman.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="malta" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/grace.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/joseph.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="marathi" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/aarohi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/mahonar.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="malayalam" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/abha.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/akhil.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/abha-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Abha <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/akhil-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Akhil <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                ...
                                <div id="norwegian" class="collapse" aria-labelledby="heading18" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/liv.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/chin.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/bjorn.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/inger.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dag.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/janne.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/chin-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Chin <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/bjorn-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Bjorn <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/inger-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Inger <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dag-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Dag <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/janne-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Janne <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hulda.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/iselin.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/pernille.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/finn.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="polish" class="collapse" aria-labelledby="heading19" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/ewa.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/maja.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/jan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Jan <span class="text-muted font-weight-normal fs-12">(M)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/jacek.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sara.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/jan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Jan <span class="text-muted font-weight-normal fs-12">(M)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/jacob.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/zofia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sara-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Sara <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/jan-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Jan <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/jacob-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Jacob <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/zofia-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Zofia <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/paulina.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/agnieszka.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/zofia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Zofia <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/marek.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Portuguese" class="collapse" aria-labelledby="heading20" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/camila.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/victoria.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/ricardo.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/camila-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Camila <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/francisca.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/francisca-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Francisca <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/daniel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/heloisa.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/francisca.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Francisca <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/antonio.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Portuguese-pt" class="collapse" aria-labelledby="heading21" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/ines.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/cristiano.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/beatriz.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/ronaldo.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/lisboa.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/mariana.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/beatriz-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Beatriz <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/ronaldo-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Ronaldo <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/lisboa-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lisboa <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/mariana-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Mariana <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/helia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/fernanda.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/raquel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/duarte.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Romanian" class="collapse" aria-labelledby="heading22" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/carmen.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/mihaela.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/mihaela-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Mihaela <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>											
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/andrei.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/alina.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/emil.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Russian" class="collapse" aria-labelledby="heading23" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/tatyana.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/maxim.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/oksana.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/vlad.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/veronika.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dapohui.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/svetlana.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/oksana-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Oksana <span class="text-muted font-weight-normal fs-12">(F)</span></span>	
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/veronika-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Veronika <span class="text-muted font-weight-normal fs-12">(F)</span></span>	
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dapohui-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Dapohui <span class="text-muted font-weight-normal fs-12">(M)</span></span>	
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/svetlana-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Svetlana <span class="text-muted font-weight-normal fs-12">(F)</span></span>	
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ekaterina.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/irina.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/pavel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/dariya.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/svetlana.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Svetlana <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/dmitry.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="serbian" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/olga.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                ...
                                <div id="slovak" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/anna.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/olga-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Olga <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/filip.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/viktoria.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/lukas.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="slovenia" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/lado.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/petra.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/rok.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="argentina" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/elena.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/tomas.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="colombia" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/salome.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/gonzalo.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Spanish" class="collapse" aria-labelledby="heading24" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/conchita.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/lucia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lucia <span class="text-muted font-weight-normal fs-12">(F)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/enrique.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/hector.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/vanessa.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/laura.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/isabella.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Isabella <span class="text-muted font-weight-normal fs-12">(F)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/hector-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Hector <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/vanessa-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Vanessa <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/laura-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Laura <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/enrique.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Enrique <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/laura.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Laura <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/helena.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/laura.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Laura <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/pablo.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/elvira.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/alvaro.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Spanish-mx" class="collapse" aria-labelledby="heading25" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/mia.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                          <span class="voice-name">Mia <span class="text-muted font-weight-normal fs-12">(F)</span></span>									  
                                      </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/sofia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hilda.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/raul.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/dalia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/jorge.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Spanish-usa" class="collapse" aria-labelledby="heading26" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/lupe.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/penelope.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/miguel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/aws/lupe-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lupe <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/mia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Mia <span class="text-muted font-weight-normal fs-12">(F)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/pedro.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sanches.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/isabella-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Isabella <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/pedro-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Pedro <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/sanches-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Sanches <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/ibm/sofia-us.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Sofia <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/paloma.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/alonso.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="swahili" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/zuri.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/rafiki.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Swedish" class="collapse" aria-labelledby="heading27" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/astrid.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/karin.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/karin-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Karin <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hedvig.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hillev.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/sofie.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/mattias.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="tamil" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/aadhish.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/oarushi-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/aadhish-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/valluvar.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/pallavi.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/valluvar-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Valluvar <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                ...
                                <div id="telugu" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/aasthika.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/aadhavan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/chitra.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/shruti.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/mohan.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="thai" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/busaba.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/pattara.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/achara.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/premwadee.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/niwat.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Turkish" class="collapse" aria-labelledby="heading28" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/filiz.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/zeynep.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/oktay.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/fatima.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/gulchatay.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/yanar.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/zeynep-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Zeynep <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/oktay-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Oktay <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/fatima-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Fatima <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/gulchatay-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Gulchatay <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/yanar-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Yanar <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/seda.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/emel.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ahmet.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="ukraine" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/polina.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/ostap.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="urdu" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/uzma.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/asad.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="vietnam" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/gcp/chau.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dung.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/cam.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/duy.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                       ...
                                       <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/chau-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Chau <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/dung-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Dung <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/cam-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Cam <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/gcp/duy-nrl.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Duy <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>										
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/an.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/hoaimy.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/namminh.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Welsh" class="collapse" aria-labelledby="heading29" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="<?php echo e(URL::asset('voices/aws/gwyneth.mp3')); ?>" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/nia.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="<?php echo e(URL::asset('voices/azure/aled.mp3')); ?>" type="audio/mpeg">
                                            </audio>	
                                        </div>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/voices.blade.php ENDPATH**/ ?>