...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0"><?php echo e(__('TTS Dashboard')); ?></h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> <?php echo e(__('TTS Dashboard')); ?></a></li>
			</ol>
		</div>
	</div>
	<!--END PAGE HEADER -->
...
<?php $__env->startSection('content'); ?>	
			...
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('AWS Characters Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font-chars"><?php echo e(number_format($vendor_data['aws_month'][0]['data'])); ?></span></h2>									
						</div>
						<img src="<?php echo e(URL::asset('img/csp/aws-lg.png')); ?>" class="csp-brand-img" alt="AWS Logo">
					</div>
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?> (<?php echo e(__('Total Usage')); ?>):</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-info"></i><?php echo e(number_format($vendor_data['aws_year'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('GCP Characters Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font-chars"><?php echo e(number_format($vendor_data['gcp_month'][0]['data'])); ?></span></h2>
						</div>
						<img src="<?php echo e(URL::asset('img/csp/gcp-lg.png')); ?>" class="csp-brand-img" alt="GCP Logo">
					</div>
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?> (<?php echo e(__('Total Usage')); ?>)</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-info"></i><?php echo e(number_format($vendor_data['gcp_year'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Azure Characters Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font-chars"><?php echo e(number_format($vendor_data['azure_month'][0]['data'])); ?></span></h2>
						</div>
						<img src="<?php echo e(URL::asset('img/csp/azure-lg.png')); ?>" class="csp-brand-img" alt="Azure Logo">
					</div>
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?> (<?php echo e(__('Total Usage')); ?>)</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-info"></i><?php echo e(number_format($vendor_data['azure_year'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('IBM Characters Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-0"><span class="number-font-chars"><?php echo e(number_format($vendor_data['ibm_month'][0]['data'])); ?></span></h2>
						</div>
						<img src="<?php echo e(URL::asset('img/csp/ibm-lg.png')); ?>" class="csp-brand-img" alt="IBM Logo">
					</div>
					<div class="d-flex mt-2">
						<div>
							<span class="text-muted fs-12 mr-1"><?php echo e(__('Current Year')); ?> (<?php echo e(__('Total Usage')); ?>)</span>
							<span class="number-font fs-12"><i class="fa fa-bookmark mr-1 text-info	"></i><?php echo e(number_format($vendor_data['ibm_year'][0]['data'])); ?></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-4  col-md-12">
			<div class="card overflow-hidden border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('Cloud Vendor TTS Service Usage')); ?> <span class="text-muted">(<?php echo e(__('Current Year')); ?>)</span></h3>
				</div>
				<div class="card-body">
					<div class="country-card">
						<div class="mb-3">
							<div class="d-flex">
								<span class="fs-12 font-weight-semibold"><img src="<?php echo e(URL::asset('img/csp/aws-sm.png')); ?>" class="w-5 h-5 mr-2" alt="">Amazon Web Services</span>
								<div class="ml-auto"><span class="text-success mr-1"></span><span class="number-font fs-14"><?php echo e(number_format($vendor_data['aws_year'][0]['data'])); ?></span> <span class="text-muted fs-12">(<span id="aws"></span>)</span></div>
							</div>
						...
						<div class="mb-3">
							<div class="d-flex">
								<span class="fs-12 font-weight-semibold"><img src="<?php echo e(URL::asset('img/csp/gcp-sm.png')); ?>" class="w-5 h-5 mr-2" alt="">Google Cloud Platform</span>
								<div class="ml-auto"><span class="text-success mr-1"></span><span class="number-font fs-14"><?php echo e(number_format($vendor_data['gcp_year'][0]['data'])); ?></span> <span class="text-muted fs-12">(<span id="gcp"></span>)</span></div>
							</div>
							<div class="progress h-2  mt-1">
						...
						<div class="mb-3">
							<div class="d-flex">
								<span class="fs-12 font-weight-semibold"><img src="<?php echo e(URL::asset('img/csp/azure-sm.png')); ?>" class="w-5 h-5 mr-2" alt="">Microsoft Azure</span>
								<div class="ml-auto"><span class="text-danger mr-1"></span><span class="number-font fs-14"><?php echo e(number_format($vendor_data['azure_year'][0]['data'])); ?></span> <span class="text-muted fs-12">(<span id="azure"></span>)</span></div>
							</div>
							<div class="progress h-2  mt-1">
						...
						<div class="mb-0">
							<div class="d-flex">
								<span class="fs-12 font-weight-semibold"><img src="<?php echo e(URL::asset('img/csp/ibm-sm.png')); ?>" class="w-5 h-5 mr-2 pb-1" alt="">IBM</span>
								<div class="ml-auto"><span class="text-success mr-1"></span><span class="number-font fs-14"><?php echo e(number_format($vendor_data['ibm_year'][0]['data'])); ?></span> <span class="text-muted fs-12">(<span id="ibm"></span>)</span></div>
							</div>
							<div class="progress h-2  mt-1">
		...
		<div class="col-xl-8 col-md-12">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-xm-12">
					<div class="card overflow-hidden border-0">
						<div class="card-body">
							<p class=" mb-3 mt-1 fs-12"><?php echo e(__('Free Characters Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-2 number-font-light"><?php echo e(number_format($tts_data_monthly['free_chars'][0]['data'])); ?></h2>
							<small class="fs-12 text-muted"><?php echo e(__('Compared to Last Month')); ?> (<span id="free_chars_past"></span>): </small>
				...
				<div class="col-lg-6 col-md-6 col-xm-12">
					<div class="card overflow-hidden border-0">
						<div class="card-body">
							<p class=" mb-3 mt-1 fs-12"><?php echo e(__('Standard Characters Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-2 number-font-light"><?php echo e(number_format($tts_data_monthly['standard_chars'][0]['data'])); ?></h2>
							<small class="fs-12 text-muted"><?php echo e(__('Compared to Last Month')); ?> (<span id="standard_chars_past"></span>):</small>
				...
				<div class="col-lg-6 col-md-6 col-xm-12">
					<div class="card overflow-hidden border-0">
						<div class="card-body">
							<p class=" mb-3 mt-1 fs-12"><?php echo e(__('Paid Characters Used')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-2 number-font-light"><?php echo e(number_format($tts_data_monthly['paid_chars'][0]['data'])); ?></h2>
							<small class="fs-12 text-muted"><?php echo e(__('Compared to Last Month')); ?> (<span id="paid_chars_past"></span>): </small>
				...
				<div class="col-lg-6 col-md-6 col-xm-12">
					<div class="card overflow-hidden border-0">
						<div class="card-body">
							<p class=" mb-3 mt-1 fs-12"><?php echo e(__('Neural Characters Used ')); ?><span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
							<h2 class="mb-2 number-font-light"><?php echo e(number_format($tts_data_monthly['neural_chars'][0]['data'])); ?></h2>
							<small class="fs-12 text-muted"><?php echo e(__('Compared to Last Month')); ?> (<span id="neural_chars_past"></span>):</small>
	...
	<div class="row mt-4">
		<div class="col-lg-12 col-md-12">
			<div class="card overflow-hidden border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('Characters Usage')); ?> <span class="text-muted">(<?php echo e(__('Current Year')); ?>)</span></h3>
				</div>
				<div class="card-body">
					<div class="row mb-5 mt-2">
						<div class="col">
							<p class="mb-1 fs-12"><?php echo e(__('Total Free Characters')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($tts_data_yearly['total_free_chars'][0]['data'])); ?></h3>
						</div>
						<div class="col ">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Paid Characters')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($tts_data_yearly['total_paid_chars'][0]['data'])); ?></h3>
						</div>
						<div class="col">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Standard Characters')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($tts_data_yearly['total_standard_chars'][0]['data'])); ?></h3>
						</div>
						<div class="col ">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Neural Characters')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($tts_data_yearly['total_neural_chars'][0]['data'])); ?></h3>
						</div>
						<div class="col ">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Audio Files Created')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($tts_data_yearly['total_audio_files'][0]['data'])); ?></h3>
						</div>
						<div class="col ">
							<p class=" mb-1 fs-12"><?php echo e(__('Total Listen Mode Results')); ?></p>
							<h3 class="mb-0 fs-20 number-font"><?php echo e(number_format($tts_data_yearly['total_listen_results'][0]['data'])); ?></h3>
						</div>
					</div>
					<div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/tts-management/dashboard/index.blade.php ENDPATH**/ ?>