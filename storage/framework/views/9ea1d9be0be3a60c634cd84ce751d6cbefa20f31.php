                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <?php if(config('settings.oauth_login') == 'enabled'): ?>
                        ...
                        <div class="actions-total text-center">
                            <?php if(config('services.facebook.enable') == 'on'): ?><a href="<?php echo e(url('/auth/redirect/facebook')); ?>" class="btn mr-2" id="login-facebook" data-toggle="tooltip" data-placement="top" title="Login with Facebook"><i class="fa fa-facebook-f"></i></a><?php endif; ?>
                            <?php if(config('services.twitter.enable') == 'on'): ?><a href="<?php echo e(url('/auth/redirect/twitter')); ?>" class="btn mr-2" id="login-twitter" data-toggle="tooltip" data-placement="top" title="Login with Twitter"><i class="fa fa-twitter"></i></a><?php endif; ?>	
                            <?php if(config('services.google.enable') == 'on'): ?><a href="<?php echo e(url('/auth/redirect/google')); ?>" class="btn mr-2" id="login-google" data-toggle="tooltip" data-placement="top" title="Login with Google"><i class="fa fa-google"></i></a><?php endif; ?>	
                            <?php if(config('services.linkedin.enable') == 'on'): ?><a href="<?php echo e(url('/auth/redirect/linkedin')); ?>" class="btn mr-2" id="login-linkedin" data-toggle="tooltip" data-placement="top" title="Login with Linkedin"><i class="fa fa-linkedin"></i></a><?php endif; ?>	
                        </div>
...
unset($__errorArgs, $__bag); ?>" name="password" autocomplete="off" placeholder="Password" required>
...
unset($__errorArgs, $__bag); ?>                            
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-sm-12 fs-10 text-muted text-center">
                            Copyright © <?php echo e(date("Y")); ?> <a href="<?php echo e(config('app.url')); ?>"><?php echo e(config('app.name')); ?></a>. <?php echo e(__('All rights reserved')); ?>
        ...
        <div class="col-md-7 col-sm-12 text-center background-special h-100 align-middle p-9" id="login-background">
            <img class="img-fluid justify-content-center" src="<?php echo e(URL::asset('img/files/login-bg.png')); ?>" alt="branding logo">
        </div>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>