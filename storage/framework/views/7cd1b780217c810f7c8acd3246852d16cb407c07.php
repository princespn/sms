					...
					<form action="<?php echo e(route('admin.settings.global.store')); ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4">General Settings</h6>
...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6>Default New User Group</h6>
											<select id="user-group" name="user-group" data-placeholder="Select Default New User Group">	
												<option value="user" <?php echo e((config('settings.default_user') == 'user') ? 'selected' : ''); ?>>User</option>
												<option value="subscriber" <?php echo e((config('settings.default_user') == 'subscriber') ? 'selected' : ''); ?>>Subscriber</option>
												<option value="admin" <?php echo e((config('settings.default_user') == 'admin') ? 'selected' : ''); ?>>Administrator</option>																		
											</select> 
										</div> 
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6>Support Ticket Emails</h6>
											<select id="support-ticket" name="support-ticket" data-placeholder="Enable/Disable Email Sending for Support Ticket Statuses">	
												<option value="enabled" <?php echo e((config('settings.support_email') == 'enabled') ? 'selected' : ''); ?>>Enable</option>
												<option value="disabled" <?php echo e((config('settings.support_email') == 'disabled') ? 'selected' : ''); ?>>Disable</option>																		
											</select> 
										</div> 
									</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/settings/global/index.blade.php ENDPATH**/ ?>