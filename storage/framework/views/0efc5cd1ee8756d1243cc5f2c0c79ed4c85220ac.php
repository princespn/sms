					...
					<form id="upgrade-form" method="POST" action="<?php echo e(route('admin.settings.upgrade.start', ['update_id' => $latest_version['update_id'], 'version' => $latest_version['version']])); ?>" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-sm-12 col-md-12">
								<h6 class="fs-14 mt-2">Current Installed Software Version: <span class="text-info font-weight-bold"><?php echo e($current_version); ?></span></h6>
								<?php if($latest_version['status']): ?>
									<div id="not-installed-info">
										<h6 class="mt-4">New<span class="text-info font-weight-bold"> <?php echo e($latest_version['version']); ?> Version</span> is available for download.</h6>
										<h6><span class="text-danger fs-14 font-weight-bold">Warning! </span>Always backup your database and script files before any upgrade.</h6>
									</div>
									<div id="installed-info">
										<h6 class="text-success fs-14 font-weight-bold mt-4"><?php echo e(config('app.name')); ?> was successfully updated to the latest version!</h6>
									</div>
								<?php else: ?>
									<h6 class="text-success fs-14 font-weight-bold mt-4">You have the latest version installed!</h6>
								<?php endif; ?>
							</div>
						</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/settings/upgrade/index.blade.php ENDPATH**/ ?>