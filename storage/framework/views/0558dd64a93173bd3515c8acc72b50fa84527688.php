...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		...
		<ol class="breadcrumb mb-2">
			...
			<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('My TTS Audio Results')); ?></a></li>
		</ol>
	</div>
</div>
<!-- END PAGE HEADER -->
		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('All My Synthesized Text Results')); ?></h3>
				</div>
					...
					<table id='resultsTable' class='table' width='100%'>
							<thead>
								<tr>
									...
									<th width="12%"><?php echo e(__('Project Name')); ?></th>     						           	
	...
	$(function () {
		...
		if ( config == 'show') {
			var table = $('#resultsTable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "<?php echo e(route('user.tts.results')); ?>",
				columns: [{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/user/tts-results/index.blade.php ENDPATH**/ ?>