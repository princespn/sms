	...
	<div class="page-header mt-5-7"> 
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('New Plan')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				...
				<div class="card-body pt-5">									
					<form action="<?php echo e(route('admin.finance.subscriptions.store')); ?>" method="POST" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="number" class="form-control" id="duration" name="duration" value="<?php echo e(old('duration')); ?>">
									</div> 
								...
								<div class="row">
									<div class="col-lg-6 col-md-6col-sm-12">							
										<div class="input-box">								
											...
											<div class="form-group">							    
												<input type="text" class="form-control" id="characters" name="characters" value="<?php echo e(old('characters')); ?>" required>
											</div> 
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6col-sm-12">							
										<div class="input-box">								
											...
											<div class="form-group">							    
												<input type="text" class="form-control" id="bonus" name="bonus" value="<?php echo e(old('bonus')); ?>" value="0">
											</div> 
						...
						<div class="row mt-2">
							<div class="col-12">
								<div class="input-box">	
									...
									<div class="form-group">							    
										<input type="text" class="form-control" id="secondary-heading" name="secondary-heading" value="<?php echo e(old('secondary-heading')); ?>">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row mt-6">
							<div class="col-lg-12 col-md-12 col-sm-12">	
								<div class="input-box">	
									...
									<textarea class="form-control" name="features" rows="10" value="<?php echo e(old('features')); ?>"></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/661037.cloudwaysapps.com/fuxkpjgyyd/public_html/resources/views/admin/finance-management/subscriptions/create.blade.php ENDPATH**/ ?>