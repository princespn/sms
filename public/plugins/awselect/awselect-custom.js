...
(function($) {
        ...
        options.each(function() {
           ...
           var data_gender = $(this).attr("data-gender");
            ...
            if (typeof $(this).attr("selected") !== typeof undefined && $(this).attr("selected") !== false) {
                if(current_img !== undefined) {
                    if(data_gender !== undefined && data_type == 'neural') {
                        selected = '<span id=current-' + data_id + '><img class="awselect-img" src="' + current_img  +'">' + $(this).text() + '<i class="text-muted no-italics fs-10">(' + data_gender + ')</i><i class="voice-neural-sign"> (Neural)</i></span>';
                    } else if(data_gender !== undefined && data_type == 'standard') {
                        selected = '<span id=current-' + data_id + '><img class="awselect-img" src="' + current_img  +'">' + $(this).text() + '<i class="text-muted no-italics fs-10">(' + data_gender + ')</i></span>';
                    } else {
            ...
            if(current_img === undefined) {
                ...
                if (data_type == 'neural') {
                    options_html += '<li><a class="' + usage_status + ' ' + data_class + ' ' + data_lang + '" style="padding: 2px '+ horizontal_padding +'"><img class="awselect-img" src="' + current_img +'">' + $(this).text() + '<span class="text-muted fs-10">(' + data_gender + ')</span><span class="voice-neural-sign"> (Neural)</span></a></li>'; 
                } else if(data_type == 'standard') {
                    options_html += '<li><a class="' + usage_status + ' ' + data_class + ' ' + data_lang + '" style="padding: 2px '+ horizontal_padding +'"><img class="awselect-img" src="' + current_img +'">' + $(this).text() + '<span class="text-muted fs-10">(' + data_gender + ')</span></a></li>'; 
                } else {
    ...
    function setValue(select) {
        ...
        if(img === undefined) {
            ...
            if (data_type == 'neural') {
                $(awselect).find(".current_value").remove();
                $(awselect).find(".front_face .content").prepend('<span id="current-' + data_id + '" class = "current_value ' + data_lang + '"><img class="awselect-img" src="' + img + '">' + option_value.text() + '<i class="text-muted fs-10 no-italics">(' + data_gender + ')</i><i class="voice-neural-sign"> (Neural)</i></span>');
            } else if(data_type == 'standard') {
                $(awselect).find(".current_value").remove();
                $(awselect).find(".front_face .content").prepend('<span id="current-' + data_id + '" class = "current_value ' + data_lang + '"><img class="awselect-img" src="' + img + '">' + option_value.text() + '<i class="text-muted fs-10 no-italics">(' + data_gender + ')</i></span>');
            } else {
                $(awselect).find(".current_value").remove();
