...
class UseCaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.settings.usecase.index');
    }
    ...
    {
        return view('admin.settings.usecase.create');
    }
    ...
    {
        return view('admin.settings.usecase.edit', compact('id'));
    }
    ...
    {  
        return view('admin.settings.usecase.delete', compact('id'));     
    }
