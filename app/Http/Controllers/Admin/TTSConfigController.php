...
class TTSConfigController extends Controller
{
    ...
    public function store()
    {
        ...
        $this->storeConfiguration('FRONTEND_LIVE_SYNTHESIZE', request('enable-listen'));
        $this->storeConfiguration('FRONTEND_MAX_CHAR_LIMIT', request('limit'));
        $this->storeConfiguration('FRONTEND_NEURAL_VOICES', request('neural'));
