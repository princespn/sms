...
use App\Http\Controllers\Admin\Settings\UseCaseController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['verified', 'role:admin', 'PreventBackHistory']], function() {
        ...
        Route::post('/tts/voices/{id}/update', [AdminTTSController::class, 'voicesUpdate'])->name('admin.tts.voices.update');  
        Route::get('/tts/voices/{id}/edit', [AdminTTSController::class, 'voicesEdit'])->name('admin.tts.voices.edit');  
        Route::post('/tts/voices/{id}/activate', [AdminTTSController::class, 'voicesActivate'])->name('admin.tts.voices.activate');  
        Route::get('/tts/voices/{id}/activate', [AdminTTSController::class, 'voicesShowActivate'])->name('admin.tts.voices.activate.show');  
        Route::get('/tts/voices/activate/all', [AdminTTSController::class, 'voicesActivateAll'])->name('admin.tts.voices.activate.all');  
        Route::delete('/tts/voices/{id}/deactivate', [AdminTTSController::class, 'voicesDeactivate'])->name('admin.tts.voices.deactivate');  
        Route::get('/tts/voices/{id}/deactivate', [AdminTTSController::class, 'voicesShowDeactivate'])->name('admin.tts.voices.deactivate.show');  
        Route::get('/tts/voices/deactivate/all', [AdminTTSController::class, 'voicesDeactivateAll'])->name('admin.tts.voices.deactivate.all');  
...
Route::group(['prefix' => 'user', 'middleware' => ['verified', 'role:user|admin|subscriber', 'PreventBackHistory']], function() {
        ...
        Route::post('/music/upload', [ProjectController::class, 'upload']);  
        Route::get('/music/list', [ProjectController::class, 'list'])->name('user.music.list');          
        Route::delete('/music/list/{id}', [ProjectController::class, 'musicDestroy'])->name('user.music.destroy'); 
        Route::get('/music/list/{id}', [ProjectController::class, 'musicDelete'])->name('user.music.delete');       
        Route::get('/project', [ProjectController::class, 'index'])->name('user.projects');
        Route::post('/project', [ProjectController::class, 'store'])->name('user.project.store');
