                                  ...
                                  <div id="arabic" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
                                    <div class="card-body mb-2">
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="{{ URL::asset('voices/aws/zeina.mp3') }}" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                  ...
                                  <div id="chinese" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionVoiceList">
                                    <div class="card-body mb-2">
                                        ...
                                        <div class="voice-player mb-6">
                                            ...
                                            <div class="text-center player">
                                                <audio class="voice-audio" preload="none">
                                                    <source src="{{ URL::asset('voices/aws/zhiyu.mp3') }}" type="audio/mpeg">
                                                </audio>	
                                            </div>
                                ...
                                <div id="danish" class="collapse" aria-labelledby="headingThree" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/naja.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/mads.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="dutch" class="collapse" aria-labelledby="headingFour" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/lotte.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/ruben.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-australia" class="collapse" aria-labelledby="headingFive" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/nicole.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/olivia.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/russell.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-in" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/aditi.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/raveena.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-uk" class="collapse" aria-labelledby="headingSix" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/amy.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/emma.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Emma <span class="text-muted font-weight-normal fs-12">(F)</span></span>								
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/brian.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/amy-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Amy <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/emma-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Emma <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/brian-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Brian <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                ...
                                <div id="english-us" class="collapse" aria-labelledby="headingEight" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/ivy.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/joanna.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Joanna <span class="text-muted font-weight-normal fs-12">(F)</span></span>								
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/kendra.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/kimberly.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/salli.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/joey.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/justin.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/matthew.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/ivy-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Ivy <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/joanna-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Joanna <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/kendra-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Kendra <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/kimberly-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Kimberly <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/Salli-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Salli <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/joey-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Joey <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/justin-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Justin <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/matthew-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Matthew <span class="text-muted font-weight-normal fs-12">(M)</span></span>
                                        <p class="neural-voice">Neural</p>								
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/kevin-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="english-welsh" class="collapse" aria-labelledby="headingNine" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/geraint.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                ...
                                <div id="french" class="collapse" aria-labelledby="headingTen" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/celine.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/lea.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/mathieu.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="french-ca" class="collapse" aria-labelledby="heading11" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/chantal.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/gabrielle-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="german" class="collapse" aria-labelledby="heading12" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/marlene.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/vicky.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/hans.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="hindi" class="collapse" aria-labelledby="heading13" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/aditi-in.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                          <span class="voice-name">Aditi <span class="text-muted font-weight-normal fs-12">(F)</span></span>									  
                                      </div><!-- END VOICE AUDIO FILE -->
                                ...
                                <div id="icelandic" class="collapse" aria-labelledby="heading14" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/dora.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/karl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="italian" class="collapse" aria-labelledby="heading15" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/carla.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/bianca.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/giorgio.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="japanese" class="collapse" aria-labelledby="heading16" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/mizuki.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/takumi.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="korean" class="collapse" aria-labelledby="heading17" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/seoyeon.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/seoyeon-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Seoyeon <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                ...
                                <div id="norwegian" class="collapse" aria-labelledby="heading18" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/liv.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                ...
                                <div id="polish" class="collapse" aria-labelledby="heading19" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/ewa.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/maja.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/jan.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Jan <span class="text-muted font-weight-normal fs-12">(M)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/jacek.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Portuguese" class="collapse" aria-labelledby="heading20" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/camila.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/victoria.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/ricardo.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/camila-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Camila <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                ...
                                <div id="Portuguese-pt" class="collapse" aria-labelledby="heading21" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/ines.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/cristiano.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Romanian" class="collapse" aria-labelledby="heading22" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/carmen.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                ...
                                <div id="Russian" class="collapse" aria-labelledby="heading23" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/tatyana.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/maxim.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Spanish" class="collapse" aria-labelledby="heading24" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/conchita.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/lucia.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lucia <span class="text-muted font-weight-normal fs-12">(F)</span></span>									
                                    </div><!-- END VOICE AUDIO FILE -->
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/enrique.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                ...
                                <div id="Spanish-mx" class="collapse" aria-labelledby="heading25" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/mia.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                          <span class="voice-name">Mia <span class="text-muted font-weight-normal fs-12">(F)</span></span>									  
                                      </div><!-- END VOICE AUDIO FILE -->
                                ...
                                <div id="Spanish-usa" class="collapse" aria-labelledby="heading26" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/lupe.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                      ...
                                      <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/penelope.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/miguel.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                    ...
                                    <div class="voice-player mb-6">
                                        ...
                                        <div class="text-center player">
                                            <audio class="voice-audio" preload="none">
                                                <source src="{{ URL::asset('voices/aws/lupe-nrl.mp3') }}" type="audio/mpeg">
                                            </audio>	
                                        </div>
                                        <span class="voice-name">Lupe <span class="text-muted font-weight-normal fs-12">(F)</span></span>
                                        <p class="neural-voice">Neural</p>									
                                ...
                                <div id="Swedish" class="collapse" aria-labelledby="heading27" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/astrid.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                ...
                                <div id="Turkish" class="collapse" aria-labelledby="heading28" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/filiz.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
                                ...
                                <div id="Welsh" class="collapse" aria-labelledby="heading29" data-parent="#accordionVoiceList">
                                  <div class="card-body mb-2">
                                      ...
                                      <div class="voice-player mb-6">
                                          ...
                                          <div class="text-center player">
                                              <audio class="voice-audio" preload="none">
                                                  <source src="{{ URL::asset('voices/aws/gwyneth.mp3') }}" type="audio/mpeg">
                                              </audio>	
                                          </div>
