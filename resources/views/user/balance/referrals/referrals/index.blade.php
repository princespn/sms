...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('All My Referrals') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('All My Referrals') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
					...
					<table id='paymentsReferralTable' class='table' width='100%'>
						<thead>
							<tr>
								...
								<th width="7%" class="fs-10">{{ __('Earned Commission') }} ({{ config('payment.default_system_currency') }})</th>
							</tr>
						</thead>
