...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('My Gateway') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="{{url('user.referral')}}"> {{ __('My Referrals') }}</a></li>
				<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('My Gateway') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-4 col-md-12 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body p-6">
					...
					<p class="fs-12 text-center">Select your preferred payment method to receive commissions.</p>
					...
					<form action="{{ route('user.referral.gateway.store') }}" method="POST" enctype="multipart/form-data">
						@csrf				
								...
								<div class="col-md-12 col-sm-12">
									<div id="audio-format" role="radiogroup">
										<div class="radio-control">
											<input type="radio" name="payment_method" class="input-control" id="PayPal" value="PayPal" @if ($user->referral_payment_method == 'PayPal') checked @endif>
											<label for="PayPal" class="label-control">PayPal</label>
										</div>	
										<span  id="option-bank">
											<div class="radio-control">
												<input type="radio" name="payment_method" class="input-control" id="BankTransfer" value="BankTransfer" @if ($user->referral_payment_method == 'BankTransfer') checked @endif>
												<label for="BankTransfer" class="label-control">Bank Transfer</label>
											</div>
										</span>									
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
									<div class="input-box">								
										<h6>Enter your Bank Account Requisites</h6> 
