...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		...
		<ol class="breadcrumb mb-2">
			<li class="breadcrumb-item"><a href="{{route('user.tts')}}"><i class="fa fa-magic mr-2 fs-12"></i>{{ __('User') }}</a></li>
			<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> Text-to-Speech</a></li>
		</ol>
	</div>
</div>
<!-- END PAGE HEADER -->
				...
				<div class="card-body pt-7 pl-7 pr-7 pb-4" id="tts-body-minify">
						...
						<form id="synthesize-text-form" action="{{ route('user.tts.synthesize') }}" listen="{{ route('user.tts.listen') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-md-3 col-sm-12 mb-1">
									<div class="form-group">									
										<div style="box-shadow:0 1px 3px 0 rgba(50, 50, 50, 0.2), 0 2px 1px -1px rgba(50, 50, 50, 0.12), 0 1px 1px 0 rgba(50, 50, 50, 0.14); height:150px; width: 300px; overflow: auto;">
										<style>table { width: 100%;} th,td { font-size:12px; padding: 5px; } th { background: white; position: sticky; top: 0; }</style>
											<table id="cl_table">
												<thead>
													<tr>
														<th>Original</th>
												...
												<tbody>
												<?php 
													$data = json_decode(file_get_contents('customlexicon.json'), true);
													ksort($data, SORT_NATURAL | SORT_FLAG_CASE);
													foreach($data as $key=>$value):
												?>
													<tr>
													<td contenteditable onblur="tableToJson(cl_table);"><?php echo $key;?></td>
													<td contenteditable onblur="tableToJson(cl_table);"><?php echo $value;?></td>
													</tr>
												<?php endforeach; ?>
											</tbody>
											</table>
										...
										<div style="padding-top: 15px;  width: 300px;">
											<input type="text" class="form-control" style="width:135px; border:1px solid #000; display: inline !important;" name="original" id="original">
											<input type="text" class="form-control" style="width:135px; border:1px solid #000; display: inline !important;" name="replacement" id="replacement">
										</div>
...
function tableToJson(table) {
	...
	xhttp.open("POST", "/public/customlexicon.php", true);
								...
								<div class="col-md-3 col-sm-12 mb-2">
									<div class="input-box mb-0" id="textarea-box">
										...
										<label class="input-label">
											<span class="input-label-content input-label-main">{{ __('Text Title (Optional)') }}</span>
										</label>
									</div>
								</div>
								<div class="col-md-3 col-sm-12 mb-2">
