...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		...
		<ol class="breadcrumb mb-2">
			<li class="breadcrumb-item"><a href="{{route('user.tts')}}"><i class="mdi mdi-access-point mr-2 fs-12"></i>{{ __('User') }}</a></li>
							...
							<div id="czeck" class="collapse" aria-labelledby="headingOne" data-parent="#accordionVoiceList">
							  <div class="card-body mb-2">
								...
								<div class="voice-player">
									...
									<div class="text-center player">
										<audio class="voice-audio" preload="none">
											<source src="{{ URL::asset('voices/ibm/alena.mp3') }}" type="audio/mpeg">
										</audio>	
									</div>
									<span class="voice-name">Alena <span class="text-muted font-weight-normal fs-12">(F)</span></span>
									<p class="neural-voice">Neural</p>										
								</div><!-- END VOICE AUDIO FILE -->	
							  </div>
							</div>
							...
							<div id="dutch" class="collapse" aria-labelledby="headingFour" data-parent="#accordionVoiceList">
							  <div class="card-body mb-2">
								...
								<div class="voice-player mb-6">
									...
									<div class="text-center player">
										<audio class="voice-audio" preload="none">
											<source src="{{ URL::asset('voices/ibm/adele.mp3') }}" type="audio/mpeg">
										</audio>	
									</div>
									<span class="voice-name">Adele <span class="text-muted font-weight-normal fs-12">(F)</span></span>
									<p class="neural-voice">Neural</p>										
								</div><!-- END VOICE AUDIO FILE -->	
								<!-- VOICE AUDIO FILE -->
								<div class="voice-player">
									...
									<div class="text-center player">
										<audio class="voice-audio" preload="none">
											<source src="{{ URL::asset('voices/ibm/bram.mp3') }}" type="audio/mpeg">
										</audio>	
									</div>
									<span class="voice-name">Bram <span class="text-muted font-weight-normal fs-12">(M)</span></span>
									<p class="neural-voice">Neural</p>										
								</div><!-- END VOICE AUDIO FILE -->	
							  </div>
							</div>
							...
							<div id="english-australia" class="collapse" aria-labelledby="headingFive" data-parent="#accordionVoiceList">
							  <div class="card-body mb-2">
								...
								<div class="voice-player">
									...
									<div class="text-center player">
										<audio class="voice-audio" preload="none">
											<source src="{{ URL::asset('voices/ibm/steve.mp3') }}" type="audio/mpeg">
										</audio>	
									</div>
									<span class="voice-name">Steve <span class="text-muted font-weight-normal fs-12">(M)</span></span>
									<p class="neural-voice">Neural</p>										
								</div><!-- END VOICE AUDIO FILE -->	
							  </div>
							</div>
							...
							<div id="french-ca" class="collapse" aria-labelledby="heading11" data-parent="#accordionVoiceList">
							  <div class="card-body mb-2">
								...
								<div class="voice-player">
									...
									<div class="text-center player">
										<audio class="voice-audio" preload="none">
											<source src="{{ URL::asset('voices/ibm/louise.mp3') }}" type="audio/mpeg">
										</audio>	
									</div>
									<span class="voice-name">Louise <span class="text-muted font-weight-normal fs-12">(F)</span></span>
									<p class="neural-voice">Neural</p>										
							...
							<div id="Portuguese" class="collapse" aria-labelledby="heading20" data-parent="#accordionVoiceList">
							  <div class="card-body mb-2">
								...
								<div class="voice-player">
									...
									<div class="text-center player">
										<audio class="voice-audio" preload="none">
											<source src="{{ URL::asset('voices/ibm/isabela.mp3') }}" type="audio/mpeg">
										</audio>	
									</div>
									<span class="voice-name">Isabela <span class="text-muted font-weight-normal fs-12">(F)</span></span>
									<p class="neural-voice">Neural</p>										
								</div><!-- END VOICE AUDIO FILE -->	
							  </div>
							</div>
							...
							<div id="Swedish" class="collapse" aria-labelledby="heading27" data-parent="#accordionVoiceList">
							  <div class="card-body mb-2">
								...
								<div class="voice-player">
									...
									<div class="text-center player">
										<audio class="voice-audio" preload="none">
											<source src="{{ URL::asset('voices/ibm/ingrid.mp3') }}" type="audio/mpeg">
										</audio>	
									</div>
									<span class="voice-name">Ingrid <span class="text-muted font-weight-normal fs-12">(F)</span></span>
									<p class="neural-voice">Neural</p>										
