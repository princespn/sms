	...
	<div class="row">
		<div class="col-lg-8 col-md-12 col-xm-12">
			...
			<form action="{{ route('admin.finance.settings.store') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="card border-0">
					<div class="card-header">
						<h3 class="card-title"><span class="text-info">Online </span> {{ __('Payment') }}</h3>
					</div>
				...
				<div class="card border-0">
					<div class="card-header">
						<h3 class="card-title"><span class="text-info">Offline </span> {{ __('Payment') }}</h3>
					</div>
					<div class="card-body">
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa fa-money fs-16 mr-2"></i>{{ __('My Balance Payment') }} <span class="text-muted">({{ __('Offline Payment') }})</span></h6>
