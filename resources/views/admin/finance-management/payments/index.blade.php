...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('All Payments') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('All Payments') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('All User Payments') }}</h3>
				</div>
					...
					<table id='listPaymentsTable' class='table' width='100%'>
							<thead>
								<tr>
									...
									<th width="10%">{{ __('Payment') }} ({{ config('payment.default_system_currency') }})</th>																																
	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#listPaymentsTable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "{{ route('admin.finance.payments') }}",
				columns: [{
						data: 'created-on',
						name: 'created-on',
						orderable: true,
