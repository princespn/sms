...
@section('content')	
	<div class="row">
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				<div class="card-body">
					<i class="mdi mdi-barcode fs-45 float-right"></i>	
					<p class=" mb-3 fs-12 font-weight-bold mt-1">{{ __('Total Referral TTS Bonus Credits') }} <span class="text-muted">({{ __('All Time') }})</span></p>
					<h2 class="mb-0"><span class="number-font-chars">{{ number_format($total_credits[0]['data']) }}</span></h2>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="card-body">
					...
					<form action="{{ route('admin.referral.settings.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								<h6 class="fs-12 font-weight-bold mb-4"><i class="mdi mdi-account-plus fs-18 referral-icon mr-2"></i>{{ __('New User Registration Referrals') }}</h6>
			...
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="row text-center justify-content-md-center">
						<div class="col-md-5 col-sm-12 referral-box special-shadow mr-5 mb-4">
							<div><i class="mdi mdi-account-network"></i></div>
							<a class="fs-12 font-weight-bold" href="{{ route('admin.referral.top') }}">Top Referrers</a>
						</div>
						<div class="col-md-5 col-sm-12 referral-box special-shadow mr-0 ml-2 mb-4">
							<div><i class="mdi mdi-account-multiple-plus"></i></div>
							<a class="fs-12 font-weight-bold" href="{{ route('admin.referral.registration') }}">Referral Registrations</a>
						</div>
					</div>
				</div>
			</div>
