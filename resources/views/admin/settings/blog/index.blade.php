...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		...
		<div class="page-rightheader">
			<a href="{{ route('admin.settings.blog.create') }}" class="btn btn-primary mt-1">Create New Blog</a>
		</div>
	</div>
	<!-- END PAGE HEADER -->
@endsection
		...
		<div class="modal-dialog modal-dialog-centered modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel"><i class="mdi mdi-alert-circle-outline color-red"></i> {{ __('Confirm Blog Post Deletion') }}</h4>
