	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('Edit Blog') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
					...
					<form id="" action="{{ route('admin.settings.blog.update', [$id->id]) }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row mt-2">							
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('Blog Title') }} <span class="text-muted">({{ __('Required') }})</span></h6>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">	
									<h6>{{ __('Blog Status') }} <span class="text-muted">({{ __('Required') }})</span></h6>
			  						<select id="smtp-encryption" name="status" data-placeholder="Blog Status:">			
										<option value="published" @if ($id->status == 'published') selected @endif>Publish</option>
										<option value="hidden" @if ($id->status == 'hidden') selected @endif>Hide</option>
									</select>
								</div> 							
							</div>
						...
						<div class="row mt-2">
							<div class="col-lg-12 col-md-12 col-sm-12">	
								<div class="input-box">	
									<h6>{{ __('Blog Post Content') }} <span class="text-muted">({{ __('Required') }})</span></h6>							
