									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											...
											<select id="user-group" name="user-group" data-placeholder="Select Default New User Group">	
												<option value="user" {{ (config('settings.default_user') == 'user') ? 'selected' : '' }}>User</option>
												<option value="subscriber" {{ (config('settings.default_user') == 'subscriber') ? 'selected' : '' }}>Subscriber</option>
												<option value="admin" {{ (config('settings.default_user') == 'admin') ? 'selected' : '' }}>Administrator</option>																		
											</select> 
										</div> 
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											...
											<select id="support-ticket" name="support-ticket" data-placeholder="Enable/Disable Email Sending for Support Ticket Statuses">	
												<option value="enabled" {{ (config('settings.support_email') == 'enabled') ? 'selected' : '' }}>Enable</option>
												<option value="disabled" {{ (config('settings.support_email') == 'disabled') ? 'selected' : '' }}>Disable</option>																		
											</select> 
										</div> 
									</div>
